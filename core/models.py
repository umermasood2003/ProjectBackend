...
class User(AbstractUser):
    ...
    gmail = models.EmailField(null=True, blank=True)   # Gmail address
    gmail_app_password = models.CharField(max_length=100, null=True, blank=True)  # App password
...
class Expense(models.Model):
    ...
    transaction_type = models.CharField(max_length=100)  # e.g. Raast Payment
